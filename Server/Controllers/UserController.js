...
const Register = async (req, res) => {
  try {
    ...
    const { name, age, nationalite, email, password, Role } = req.body;
...
const DeleteUsers = async (req, res) => {
  try {
    ...
    res.json({ msg: "The user is deleted", DeletedUsers });
  } catch (error) {
    console.log(error);
  }
};

module.exports = { Register, Login, getAllDataUSers, DeleteUsers };
